...
def generate_country_wise(mapper1,mapper2,graph):
    ...
    nx.write_gexf(graph,"/scratch1/ashwinba/cache/plt_countrywise_coretweet_img.gexf")
    #plt.savefig("/scratch1/ashwinba/cache/plt_countrywise_coretweet_img.png1.png")

    print("Executed")

    
RAW_GRAPH_DIR = "/scratch1/ashwinba/cache/coRetweet.gml.gz"
