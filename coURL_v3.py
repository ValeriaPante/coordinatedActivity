...
# - 1 Pandas DataFrame
# Mandatory Columns = ['userid','embeddedUrls']
# ['userid' --> numerical encoding of author]

def coURL(cum,n_urls=9):    
    ...
    # Filtering based on # of occurances of the urls
    cum = cum.loc[cum['urls'].isin(temp.loc[temp['userid']>n_urls]['urls'].to_list())]
